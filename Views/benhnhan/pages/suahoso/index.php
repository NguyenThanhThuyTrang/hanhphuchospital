        ...
        <form action="" method="POST">
            <div class="row g-3" id="formFields">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="cccdbenhnhan" name="cccdbenhnhan" value="<?php echo $benhnhan['cccdbenhnhan']; ?>" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="sdtbenhnhan" name="sdtbenhnhan" value="<?php echo $benhnhan['sdtbenhnhan']; ?>" required>
                </div>
